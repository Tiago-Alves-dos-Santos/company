@if ($tags_value['TAG_TEAM_MEMBERS']->visible ?? false)
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <div class="member">
                        <div class="member-img">
                            <img src="{{ $value->profile_picture }}" class="img-fluid" alt="">
                            {{-- <img src="{{ $value->profile_picture }}" style="width: 330px; height: 330px" alt=""> --}}
                            <div class="social">
                                <a href="{{ $value->facebook_link }}" target="_blank"><i class="bi bi-facebook"></i></a>
                                <a href="{{ $value->instagram_link }}" target="_blank"><i class="bi bi-instagram"></i></a>
                            </div>
                        </div>
